...
```{r, mutagenesis, fig.cap="(ref:mutagenesis)", echo=FALSE, dpi=150}
knitr::include_graphics("assets/nrg730-i2.png") 
```
...
```{r, tallplant, fig.cap="(ref:tallplant)", echo=FALSE}
knitr::include_graphics("assets/tall_plant.jpg") 
```
...
```{r, ngm, fig.cap="(ref:crossing)", echo=FALSE, dpi=150}
knitr::include_graphics("assets/ngm.png") 
```
