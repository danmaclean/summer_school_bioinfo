...
```{r csnpb4, fig.cap="(ref:candisnp)", echo=FALSE, dpi=150}
...
```{r csnp, fig.cap="(ref:candisnpf)", echo=FALSE, dpi=150}
knitr::include_graphics("assets/candisnp_after.png") 
```
...
```{r densityp, fig.cap="(ref:density)", echo=FALSE, dpi=150}
knitr::include_graphics("assets/density.png") 
```
